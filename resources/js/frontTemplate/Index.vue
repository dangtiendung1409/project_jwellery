<template>
    <Layout>
        <template v-slot:content="slotProps">
                    ...
                    <div class="main-slider-active">
                        <div class="single-slider">
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    <div class="slider-main-img" data-background="/front_assets/img/slider/slider_main_img01.jpg"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="slider-bg" data-background="/front_assets/img/slider/slider_bg01.jpg">
                        ...
                        <div class="single-slider">
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    <div class="slider-main-img" data-background="/front_assets/img/slider/slider_main_img02.jpg"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="slider-bg" data-background="/front_assets/img/slider/slider_bg01.jpg">
                                        <div class="slider-content">
                        ...
                        <div class="single-slider">
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    <div class="slider-main-img" data-background="/front_assets/img/slider/slider_main_img03.jpg"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="slider-bg" data-background="/front_assets/img/slider/slider_bg01.jpg">
                                        <div class="slider-content">
                        ...
                        <div class="single-slider">
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    <div class="slider-main-img" data-background="/front_assets/img/slider/slider_main_img04.jpg"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="slider-bg" data-background="/front_assets/img/slider/slider_bg01.jpg">
                                        <div class="slider-content">
                    ...
                    <div class="slider-bottom-nav">
                        <div class="main-slider-nav">
                            <div class="slider-nav-item">
                                <img src="/front_assets/img/slider/slider_bottom_img01.jpg" alt="">
                            </div>
                            <div class="slider-nav-item">
                                <img src="/front_assets/img/slider/slider_bottom_img02.jpg" alt="">
                            </div>
                            <div class="slider-nav-item">
                                <img src="/front_assets/img/slider/slider_bottom_img03.jpg" alt="">
                            </div>
                            <div class="slider-nav-item">
                                <img src="/front_assets/img/slider/slider_bottom_img04.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-12 col-sm-10">
                            <div class="cat-banner-item banner-animation mb-20">
                                <a href="shop-sidebar.html"><img src="/front_assets/img/images/cat_banner_img01.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cat-banner-item banner-animation mb-20">
                                        <div class="thumb">
                                            <a href="shop-sidebar.html"><img src="/front_assets/img/images/cat_banner_img02.jpg" alt=""></a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="col-md-6">
                                    <div class="cat-banner-item banner-animation mb-20">
                                        <div class="thumb">
                                            <a href="shop-sidebar.html"><img src="/front_assets/img/images/cat_banner_img03.jpg" alt=""></a>
                                        </div>
                                        <div class="content">
                                            <span>NEW COLLECTION</span>
                                ...
                                <div class="col-12">
                                    <div class="cat-banner-item style-two banner-animation mb-20">
                                        <div class="thumb">
                                            <a href="shop-sidebar.html"><img src="/front_assets/img/images/cat_banner_img04.jpg" alt=""></a>
                                        </div>
                                        <div class="content">
                                            <span>NEW COLLECTION</span>
                            ...
                            <div class="row features-product-active">
                                    ...
                                    <div class="features-product-item mb-30">
                                        <div class="features-product-thumb">
                                            ...
                                            <a href="shop-details.html">
                                                <img src="/front_assets/img/product/features_product01.jpg" alt="">
                                            </a>
                                ...
                                <div class="col">
                                    <div class="features-product-item mb-30">
                                        <div class="features-product-thumb">
                                            <a href="shop-details.html">
                                                <img src="/front_assets/img/product/features_product02.jpg" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item mb-30">
                                        <div class="features-product-thumb">
                                            <a href="shop-details.html">
                                                <img src="/front_assets/img/product/features_product03.jpg" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item mb-30">
                                        <div class="features-product-thumb">
                                            <a href="shop-details.html">
                                                <img src="/front_assets/img/product/features_product04.jpg" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item mb-30">
                                        <div class="features-product-thumb">
                                            <div class="discount-tag">-20%</div>
                                            <a href="shop-details.html">
                                                <img src="/front_assets/img/product/features_product05.jpg" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="col">
                                    <div class="features-product-item mb-30">
                                        <div class="features-product-thumb">
                                            <div class="discount-tag">-20%</div>
                                            <a href="shop-details.html">
                                                <img src="/front_assets/img/product/features_product06.jpg" alt="">
                                            </a>
                                            <div class="product-overlay-action">
                                                <ul>
                                                    <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
            ...
            <!-- discount-area -->
            <section class="discount-area discount-bg jarallax parallax-img" data-background="/front_assets/img/bg/discount_bg.jpg">
                <div class="container">
                    <div class="row justify-content-center justify-content-lg-start">
                        <div class="col-lg-6 col-md-10">
                            <div class="discount-content text-center">
                                <div class="icon mb-15"><img src="/front_assets/img/icon/discount_icon.png" alt=""></div>
                            ...
                            <div class="tab-content tp-tab-content" id="trendingTabContent">
                                <div class="tab-pane show active" id="accessories" role="tabpanel" aria-labelledby="accessories-tab">
                                    <div class="trending-products-banner banner-animation">
                                        <a href="shop-sidebar.html"><img src="/front_assets/img/images/trending_banner.jpg" alt=""></a>
                                    </div>
                                    <div class="row trending-product-active">
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="/front_assets/img/product/trending_product01.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="/front_assets/img/product/trending_product02.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="/front_assets/img/product/trending_product03.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <a href="shop-details.html">
                                                        <img src="/front_assets/img/product/trending_product04.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="/front_assets/img/product/trending_product05.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                        ...
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="/front_assets/img/product/trending_product06.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                ...
                                <div class="tab-pane" id="bags" role="tabpanel" aria-labelledby="bags-tab">
                                    <div class="trending-products-banner banner-animation">
                                        <a href="shop-sidebar.html"><img src="/front_assets/img/images/trending_banner02.jpg" alt=""></a>
                                    </div>
                                    <div class="row trending-product-active">
                                        <div class="col">
                                            <div class="features-product-item">
                                                <div class="features-product-thumb">
                                                    <div class="discount-tag">-20%</div>
                                                    <a href="shop-details.html">
                                                        <img src="/front_assets/img/product/trending_product07.jpg" alt="">
                                                    </a>
                                                    <div class="product-overlay-action">
                                                        <ul>
                                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
            ...
            <section class="newsletter-area">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="newsletter-bg" data-background="/front_assets/img/bg/newsletter_bg.jpg">
                    ...
                    <div class="row brand-active">
                        <div class="col">
                            <div class="brand-item">
                                <a href="#"><img src="/front_assets/img/brand/brand_item01.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="brand-item">
                                <a href="#"><img src="/front_assets/img/brand/brand_item02.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="brand-item">
                                <a href="#"><img src="/front_assets/img/brand/brand_item03.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="brand-item">
                                <a href="#"><img src="/front_assets/img/brand/brand_item04.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="brand-item">
                                <a href="#"><img src="/front_assets/img/brand/brand_item05.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="brand-item">
                                <a href="#"><img src="/front_assets/img/brand/brand_item06.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    ...
                                    <img src="/front_assets/img/instagram/insta_post01.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/front_assets/img/instagram/insta_post02.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/front_assets/img/instagram/insta_post03.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/front_assets/img/instagram/insta_post04.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/front_assets/img/instagram/insta_post05.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/front_assets/img/instagram/insta_post06.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="#">
                                    <i class="fab fa-instagram"></i>
                                    <img src="/front_assets/img/instagram/insta_post07.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
